...
class GeneratedQuarry(BaseStructure):
    ...
    def build(self, worldModif, buildingCondition, chestGeneration):
        ...
        self.listOfBlocks = numpy.array([])
        self.setSize([11, 11, 11])
        uselessBlocks = ["minecraft:air", "minecraft:cave_air", "minecraft:grass", "minecraft:tall_grass",
         "minecraft:poppy", "minecraft:water", "minecraft:lava", "minecraft:dead_bush", "minecraft:cactus", "minecraft:sugar_cane"]
        ## Building the quarry.
        ...
        # Set a chest
        worldModif.setBlock(cx+5, cy + 1, cz - 2, "minecraft:chest", True)
        ...
        worldModif.setBlock(cx-1, cy+1, cz-1, "minecraft:oak_fence")
        ...
        for i in range(self.size_x() + 1):
            for y in range(self.size_y()):
                ...
                if  block in uselessBlocks:
                    worldModif.setBlock(cx+i, cy-y, cz-1, "minecraft:oak_fence")
            worldModif.setBlock(cx+i, cy+1, cz-1, "minecraft:oak_fence")
        ...
        for j in range(self.size_z() + 1):
            for y in range(self.size_y()):
                ...
                # Check if there is an useless block below so we can replace it with a fence
                if block in uselessBlocks:
                    worldModif.setBlock(cx+self.getSize()[0], cy-y, cz+j, "minecraft:oak_fence")
            worldModif.setBlock(cx+self.getSize()[0], cy+1, cz+j, "minecraft:oak_fence")
        ...
        for k in range(self.size_x() + 1):
            for y in range(self.size_y()):
                ...
                # Check if there is an useless block below so we can replace it with a fence
                if block in uselessBlocks:
                    worldModif.setBlock(cx-k+self.getSize()[0], cy-y, cz+self.getSize()[2], "minecraft:oak_fence")
            worldModif.setBlock(cx-k+self.getSize()[0], cy+1, cz+self.getSize()[2], "minecraft:oak_fence")
        ...
        for l in range(self.size_z() + 1):
            for y in range(self.size_y()):
                ...
                # Check if there is an useless block below so we can replace it with a fence
                if block in uselessBlocks:
                    worldModif.setBlock(cx-1, cy-y, cz+l, "minecraft:oak_fence")
            worldModif.setBlock(cx-1, cy+1, cz+l, "minecraft:oak_fence")
        ...
        for y in range(self.size_y()):
            ...
            if block == "minecraft:oak_fence":
                worldModif.setBlock(cx-1, cy-y, cz+z, "minecraft:oak_fence_gate[facing=east]")
        worldModif.setBlock(cx-1, cy+1, cz+z, "minecraft:oak_fence_gate[facing=east]")
